  ...
  return (
    <Box sx={{ }}>
      <TabContext value={value}>
        ...
        <Card sx={{ borderRadius: '8px', border: 2, borderColor: '#F3F3F3', boxShadow: 0 , height:60, width: 200, minWidth: 50, minHeight: 10,
        top: 200,
        left: "10%",
        alignItems: "center"
        }}
    ...
    <Card sx={{ borderRadius: '8px', border: 2, borderColor: '#F3F3F3', boxShadow: 0 , height:60, width: 200, minWidth: 50, minHeight: 10, alignItems:"center",
    top: 280,
    left: "10%",
     }}
