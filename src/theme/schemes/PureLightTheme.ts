...
const colors = {
  ...
  alpha: {
    ...
    customBlue:{
      5: alpha(themeColors.customBlue, 0.02),
      10: alpha(themeColors.customBlue, 0.1),
      30: alpha(themeColors.customBlue, 0.3),
      50: alpha(themeColors.customBlue, 0.5),
      70: alpha(themeColors.customBlue, 0.7),
      100: themeColors.customBlue
    }
  },
  secondary: {
    ...
    MuiAccordion: {
      styleOverrides: {
        root: {
          ...
          '&.expand_disabled .MuiAccordionSummary-root:hover': {
            cursor: 'default'
          }
        }
      }
      ...
      styleOverrides: {
        root: {
          ...
          '&.Mui-selected, &.Mui-selected:hover': {
            /* color: colors.alpha.white[100], */
            color: colors.alpha.customBlue[100],
            zIndex: 5
          },
          '&:hover': {
            color: colors.alpha.black[100]
