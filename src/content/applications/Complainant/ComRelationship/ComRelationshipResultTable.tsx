...
import ComRelationshipSearchAccessRightRequestComponent from './ComRelationshipSearchTable'
...
const ComRelationshipResultTable: FC<UserTableProp> = ({ }) => {
  ...
  const isSelectAll = (isSelectAll: true) =>{
  ...
  const resultTableColumns = [
    { name: t('No.'), key: 'usdReqNo', seq: 1, type: 'string', style: {}, canOrder: true }
    , { name: t('Relationship'), key: 'usdUsrUi', seq: 2, type: 'string', canOrder: true }
    , { name: t('Subject person'), key: 'usdDocClass', seq: 4, type: 'string', canOrder: true }
  ]
  ...
  return (
    <Box id="com-relationship-mgmnt">
      <ComRelationshipSearchAccessRightRequestComponent
...
export default ComRelationshipResultTable;
