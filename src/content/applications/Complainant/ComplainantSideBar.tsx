...
import ComParticular from './ComParticulars';
...
const ComplainantSideBar: FC<UserTableProp> = ({ }) => {
  ...
  const menuLink = {
    ...
    "com-contact-mean": {
      link: "com-contact-mean",
      name: t("Means of Contact"),
    ...
    "com-m-and-c": {
      link: "com-m-and-c",
      name: t("Medical Findings"),
      //privilege: CATSLAS_PRIVILEGE_RETRIEVE_AND_DOWNLOAD_ARCHIVAL_RECORDS,
    },
    "com-relationship": {
      link: "com-relationship",
      name: t("Relationship with Other Person"),
      //privilege: CATSLAS_PRIVILEGE_RETRIEVE_AND_DOWNLOAD_ARCHIVAL_RECORDS,
    },
  }
  ...
  const resultTableColumns = [
    ...
    , { name: t('Classification'), key: 'classification', seq: 6, type: 'string', canOrder: true }
  ...
  return (
    <Box id="com-document-class-access-mgmnt">
      <AppBar position="static" style={{ backgroundColor: "#094880" }} >
        <Toolbar>
          {
            Object.entries(menuLink).map(([key, value]) => {
              return (
                <ListItem key={key} component="div" style={{ height: "40px" }}>
                  <Button 
                      style={{ color: 'white', height: "40px", whiteSpace: "nowrap"}}
                      disableRipple
          ...
          {/* <Button color="inherit">Particulars</Button>
          <Button color="inherit">Means of Contact </Button>
          <Button color="inherit">Other</Button>
          <Button color="inherit">Medical Findings</Button>
          <Button color="inherit">Relationship with Other Person</Button> */}
        </Toolbar>
      </AppBar>
...
export default ComplainantSideBar;
