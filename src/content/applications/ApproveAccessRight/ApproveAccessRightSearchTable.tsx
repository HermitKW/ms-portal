...
import { Button, Container, FormControl, Grid, InputLabel, MenuItem, Select, TextField, TablePagination, } from "@mui/material";
...
type SearchAccessRightRequestPopupProps = {
    ...
    approveOrRejectSucceed: any,
    setApproveOrRejectSucceed: any,
    order: any,
    orderBy: any,
}
...
const SearchAccessRightRequestComponent: FC<SearchAccessRightRequestPopupProps> =
    ({
        ...
        setShowMessage,
        documentClassMaps,
        approveOrRejectSucceed,
        setApproveOrRejectSucceed,
        order,
        orderBy,
    }) => {
        ...
        useEffect(() => {
            if (approveOrRejectSucceed) {
                searchAccessRightRequest();
                setApproveOrRejectSucceed(false);
            }
        }, [approveOrRejectSucceed]);
        ...
        const loadAccessRightRequest = (limit: number, page: number) => {
            ...
            axios.post(`${INTELLIGENCE_SHARING_RPT_SERVICE_URL}/api/v1/log-report/approve-access-rights`,
                {
                    "usdReqNo": requestNo,
