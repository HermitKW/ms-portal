...
type RejectRequestPopupProps = {
    rejectReuqestPopUp: any,
    remarks: any,
    setRemarks: any,
    setRejectReuqestPopUp: any,
    submitReject: any,
}

const RejectRequestPopupComponent: FC<RejectRequestPopupProps> =
    ({
        rejectReuqestPopUp,
        remarks,
        setRemarks,
        setRejectReuqestPopUp,
        submitReject,
    }) => {
...
export default RejectRequestPopupComponent;