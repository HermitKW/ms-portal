...
type ApproveRequestPopupProps = {
    approveReuqestPopUp: any,
    remarks: any,
    setRemarks: any,
    setApproveReuqestPopUp: any,
    submitApprove: any,
}

const ApproveRequestPopupComponent: FC<ApproveRequestPopupProps> =
    ({
        approveReuqestPopUp,
        remarks,
        setRemarks,
        setApproveReuqestPopUp,
        submitApprove,
    }) => {
...
export default ApproveRequestPopupComponent;