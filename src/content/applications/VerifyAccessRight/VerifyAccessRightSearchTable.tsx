...
type SearchAccessRightRequestPopupProps = {
    ...
    supportOrUnSupportSucceed: any,
    setSupportOrUnSupportSucceed: any,
    order: any,
    orderBy: any,
}
...
const SearchAccessRightRequestComponent: FC<SearchAccessRightRequestPopupProps> =
    ({
        ...
        setShowMessage,
        documentClassMaps,
        supportOrUnSupportSucceed,
        setSupportOrUnSupportSucceed,
        order,
        orderBy,
    }) => {
        ...
        useEffect(() => {
            if (supportOrUnSupportSucceed) {
                searchAccessRightRequest();
                setSupportOrUnSupportSucceed(false);
            }
        }, [supportOrUnSupportSucceed]);
        ...
        const loadAccessRightRequest = (limit: number, page: number) => {
            ...
            axios.post(`${INTELLIGENCE_SHARING_RPT_SERVICE_URL}/api/v1/log-report/verify-access-rights`,
                {
                    "usdReqNo": requestNo,
